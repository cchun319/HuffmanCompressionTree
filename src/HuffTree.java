...
implements Comparable
{
	...
	private void tra_h(IHuffBaseNode N)
	{
		if(N == null)
		{
			return;
		...
		if(N.isLeaf())
		{
			System.out.println("end: " + (char)((HuffLeafNode)N).element() + " | "+ ((HuffLeafNode)N).weight());
			return;
		}
		System.out.println("internal: " + N.weight());
		tra_h(((HuffInternalNode)N).left());
		tra_h(((HuffInternalNode)N).right());
		return;
	}
